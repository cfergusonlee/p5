...
I used Exploratory Data Analysis to identify / engineer the above 9 features to 
...
features (second plot below), they created clear boundaries that helped improve 
my classifier.The fraction of emails sent to a POI (x-axis) below 16% and above 
...
relative impact. Below that are the evaluation metrics when I used all 21 
original variables vs just the above 9:
...
<img src = 'screenshots/Screen Shot 2017-07-09 at 1.22.39 AM.png'>

The plots below helped me further understand the underlying nature of the 
financial and email variables:
...
None-the-less, the explained variance ratios from PCA were: 
...
particular algorithm? What parameters did you tune? (Some algorithms do not have
...
combinations of input arguments. This applies to both pre-processing steps like 
PCA and the algorithm chosen.  I used GridSearchCV to accomplish this.  It 
allowed me to try several different parameters at once and it automatically 
chose the best combination for me.  I tried a range of 2-11 PCA components and 
found that PCA didn't help my model much. When testing the DecisionTree 
classifier, I was able to experiment with different max_depths,
min_samples_splits and criteria.  We calculated entropy for various scenarios in
...
<img src='https://help.kcura.com/9.4/Content/Resources/Images/Recipes/How_to_Calculate_Precision_and_Recall_without_a_Control_Set/SCR_PrecisionEquation.png'>

<img src='https://help.kcura.com/9.4/Content/Resources/Images/Recipes/How_to_Calculate_Precision_and_Recall_without_a_Control_Set/SCR_RecallEquation_821x99.png'>
...
high recall scores and low precision scores.